<nav class="menu-nav position-fixed w-100">
    <div class="container navbar navbar-dark navbar-expand-lg p-0 menu-nav">
        <a class="navbar-brand m-0 p-2 text-white" href="#">Blog <strong>Desenvolvedor</strong></a>
        <button class="navbar-toggler bg-blue p-2 m-2" type="button" data-toggle="collapse"
